import { clearMessages, handleEditPanel, Panel } from '@renderer/features/panelSlice'
...
function EditPanelModal({ setIsModalOpen , panel }: CreatePanelProps): JSX.Element {
  ...
  const handleSubmit: FormikConfig<FormikValues>['onSubmit'] = (values) => {
    ...
    dispatch(handleEditPanel(updatedPanel)) // Dispatch the updated panel
      ...
      <div className="flex flex-col items-center gap-6 h-full text-black w-full bg-white px-4">
        ...
        <Formik
          ...
          initialValues={{
            ...
            uploadCode: panel.uploadCode,
            wanIp: panel.wanIp,
            wanPort: panel.wanPort,
            localIp: panel.localIp,
            localPort: panel.localPort,
